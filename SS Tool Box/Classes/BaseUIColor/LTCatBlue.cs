...
namespace SS_Tool_Box.Classes.BaseUIColor
{
    class LTCatBlue      //配色类：龙猫蓝
    {
        ...
        public SolidColorBrush FontTopbrush = new SolidColorBrush();   //顶栏字体颜色
        ...
        public LTCatBlue(bool DarkMode)
        {
            ...
            {
                Cardbrush.Color = Color.FromArgb(190, 7, 21, 34);
                Fontbrush.Color = Color.FromArgb(255, 255, 255, 255);
                FontTopbrush.Color = Color.FromArgb(255, 255, 255, 255);
                Fgbrush = Fontbrush;
                Bgbrush.Color = Color.FromArgb(255, 17,112,207);
